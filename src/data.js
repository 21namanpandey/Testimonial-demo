const reviews = [
  {
    id: 1,
    name: "Naman Pandey",
    job: "Aspiring Full Stack Developer",
    image: "https://media.licdn.com/dms/image/D4D03AQHFJ-HN1a15-A/profile-displayphoto-shrink_200_200/0/1689074490436?e=1700092800&v=beta&t=AsTJ2YH8sa2uPkz2xiEXuypRudL_doT2sn7vqqvmHPU",
    text: "I have a profound passion for programming and an insatiable thirst for the latest technological developments. From MERN Full Stack Web Development to mastering Java, Python, C, and unraveling the secrets of Data Structures and Algorithms (DSA),",
  },
  {
    id: 2,
    name: "Pranay Gupta",
